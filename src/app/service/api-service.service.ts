...
export class ApiServiceService {
  ...
  getGrpahicalCurrencyData(idCoin: string, currency: string, days: number){
    return this.http.get<any>(`https://api.coingecko.com/api/v3/coins/${idCoin}/market_chart?vs_currency=${currency}&days=${days}`);
  }

  getCurrencyById(idCoin: string){
    return this.http.get<any>(`https://api.coingecko.com/api/v3/coins/${idCoin}`);
  }
